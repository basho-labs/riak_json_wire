...
class DBTest < Test::Unit::TestCase
    ...
    def test_findall_by_field()
        @@db.collection("testCollection4").insert({"i" => 10})
        @@db.collection("testCollection4").insert({"i" => 20})
        @@db.collection("testCollection4").insert({"i" => 30})
        @@db.collection("testCollection4").insert({"i" => 40})
        @@db.collection("testCollection4").insert({"i" => 50})
